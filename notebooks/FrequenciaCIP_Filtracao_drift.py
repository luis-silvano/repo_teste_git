...
sink_path_consolidado = '/mnt/consumezone/Brazil/Supply/Producao/FrequenciaCIP/Fatos/ConsolidadoParciais/FatoConsolidadoParcialEquipamentosFiltracao_TMP'
...
spark.conf.set('spark.sql.sources.partitionOverwriteMode', 'dynamic')
df_consolidado_final.write.mode('overwrite').format(consume_file_type).save(sink_path_consolidado)
